...
func IsInterfaceInNS(nodeName, intf string, ns string) (bool, error) {
...
func IsInterfaceInDefaultNetns(nodeName, intf string) (bool, error) {
...
func InterfaceIsUp(nodeName, intf string) (bool, error) {
	exec, err := executor.ForNode(nodeName)
	if err != nil {
		return false, err
	}
